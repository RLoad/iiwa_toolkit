...
class IiwaRosMaster 
{
  public:
    ...
    bool init(){
        ...
        // _MeasurePublisher = _n.advertise<std_msgs::Float64MultiArray>(ns+"/measure",1);
  ...
  private:
    ...
    void publishEEInfo(){
        ...
        // Eigen::VectorXd meausure_manipu =  _controller->getMeasure();
        // for (int i = 0; i < meausure_manipu.size(); ++i)
        // {
        //     msg3.data.push_back(meausure_manipu(i));
        // }
