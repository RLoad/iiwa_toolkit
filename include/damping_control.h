...
//|
#ifndef __DAMPING_CONTROL__
#define __DAMPING_CONTROL__
#include "ros/ros.h"
...
private:
    ...
    std::unique_ptr<DampingDS> dsContPos;
    std::unique_ptr<DampingDS> dsContOri;
    
public:
    DampingControl();
    DampingControl(const std::string& urdf_string,const std::string& end_effector);
    ~DampingControl();
